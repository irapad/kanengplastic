    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center py-12 bg-card/30 backdrop-blur-sm rounded-2xl border border-border/50 mb-12">
          ...
          <h3 className="text-2xl font-bold text-foreground mb-4">งานพิมพ์ 1-4 สี พร้อมให้บริการ</h3>
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            ตัวอย่างงานพิมพ์คุณภาพสูง 1-4 สี พร้อมรับสั่งผลิต MOQ เริ่มต้น 1,000 ใบ 
            งานพิมพ์ 5-8 สี กำลังจัดเตรียมให้เร็ว ๆ นี้
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <div className="bg-gradient-to-r from-green-500/20 to-teal-500/20 px-4 py-2 rounded-full">
              <span className="text-sm font-medium">✅ 1-2 สี พร้อมแล้ว</span>
            </div>
            <div className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 px-4 py-2 rounded-full">
              <span className="text-sm font-medium">✅ 3-4 สี พร้อมแล้ว</span>
            </div>
            <div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 px-4 py-2 rounded-full">
              <span className="text-sm font-medium">🔄 5-8 สี กำลังมา</span>
            </div>
          </div>
        </div>
